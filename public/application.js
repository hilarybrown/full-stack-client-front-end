...
var config = {
  apiOrigins: {
    ...
    production: 'https://stormy-sea-27251.herokuapp.com/'
  }
};
...
var movieEvents = __webpack_require__(16);
...
var movieApi = __webpack_require__(17);
var movieUi = __webpack_require__(18);
var getFormFields = __webpack_require__(6);

var onGetMovies = function onGetMovies(event) {
  event.preventDefault();
  movieApi.getMovies().then(function (movies) {
    $(document).on('submit', '#edit-movie', onUpdateMovie);
    return movies;
  }).then(movieUi.getMoviesSuccess).catch(movieUi.getMoviesFailure);
};

var onNewMovie = function onNewMovie(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  movieApi.newMovie(data).then(movieUi.newMovieSuccess).catch(movieUi.newMovieFailure);
};

var onRemoveMovie = function onRemoveMovie(event) {
  event.preventDefault();
  var data = $(event.target).parent().attr('data-id');
  movieApi.removeMovie(data).then(movieUi.removeMovieSuccess).catch(movieUi.removeMovieFailure);
};
...
var onUpdateMovie = function onUpdateMovie(event) {
  ...
  movieApi.updateMovie(movieId, data).then(movieUi.updateMovieSuccess).catch(movieUi.updateMovieFailure);
};
...
var showMovie = function showMovie(data) {
  return $.ajax({
...
var removeMovie = function removeMovie(data) {
  return $.ajax({
    url: config.apiOrigin + '/movies/' + data,
    method: 'DELETE',
    headers: {
...
var updateMovie = function updateMovie(movieId, data) {
  return $.ajax({
...
var getMoviesFailure = function getMoviesFailure(data) {
  $('#appMessage').show();
  $('#appMessage').text('Error bringing back your movies. Two thumbs, way down.');
};

var newMovieSuccess = function newMovieSuccess(data) {
...
var newMovieFailure = function newMovieFailure(data) {
  $('#userMessage').text('Error saving your movie. Womp womp.');
};

var removeMovieSuccess = function removeMovieSuccess(data) {
  $('#appMessage').show();
  $('#appMessage').text("Your movie has been removed. Click 'View All Movies' to see the updated list.");
};

var removeMovieFailure = function removeMovieFailure(data) {
  $('#appMessage').show();
...
module.exports = {
  ...
  newMovieSuccess: newMovieSuccess,
  newMovieFailure: newMovieFailure,
  removeMovieSuccess: removeMovieSuccess,
  removeMovieFailure: removeMovieFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "        <!-- setting up an array, calling it movies and having each go through the entire movies array and pulling back all enterable data, per below -->\n        <div class=\"movies-table\" data-id=\""
    ...
    + "</h6>\n            <h6><strong>Brief Plot Description:</strong> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
    + "</h6>\n            <h6><strong>Have You Watched It?:</strong> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.was_watched : stack1), depth0))
    + "</h6>\n            <h6><strong>Rating:</strong> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.rating : stack1), depth0))
    + "</h6>\n            <h6><strong>Worth Re-watching?:</strong> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.re_watch : stack1), depth0))
    + "</h6>\n              <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"button\" class=\"editButton btn btn-default\" data-toggle=\"modal\" data-target=\"#editMovieModal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Edit</button>\n              <button class=\"btn btn-default remove\" type=\"button\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Remove</button>\n        </div>\n\n\n        <!-- Edit Movie Modal -->\n          <div class=\"modal fade\" id=\"editMovieModal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\">\n            <!--  removed class=\"update-hike-moda\"-->\n            <div class=\"modal-dialog\" role=\"document\">\n              <div class=\"modal-content\">\n                <div class=\"modal-header\">\n                  <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n                       <span aria-hidden=\"true\">&times;</span>\n                     </button>\n                  <h5 class=\"edit-movie-modal-title\">Edit Movie</h5>\n                </div>\n                <div class='this-movie' data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n                 <h6>Title: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
    + "</h6>\n                 <h6>Genre: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.genre : stack1), depth0))
    + "</h6>\n                 <h6>Breif Description: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
    + "</h6>\n\n                  <form id=\"edit-movie\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n                    <fieldset>\n                    <input type='hidden' name='movie[id]' value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n                    <h6><strong>Have You Watched It?: </strong></h6><select class='was_watched' name='movie[was_watched]' value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.was_watched : stack1), depth0))
    + "\">\n                      <option value='Yes'>Yes</option>\n                      <option value='No'>No</option>\n                    </select>\n                    <h6><strong>Rating (choose '1' if not watched): </strong></h6><select class='rating' name='movie[rating]' value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.rating : stack1), depth0))
    + "\">\n                      <option value='1'>1</option>\n                      <option value='2'>2</option>\n                      <option value='3'>3</option>\n                      <option value='4'>4</option>\n                      <option value='5'>5</option>\n                    </select>\n                    <h6><strong>Worth Re-watching?: </strong></h6><select class='re_watch' name='movie[re_watch]' value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.re_watch : stack1), depth0))
    + "\">\n                      <option value='Yes'>Yes</option>\n                      <option value='No'>No</option>\n                      <option value=\"Haven't Watched Yet\">Haven't Watched Yet</option>\n                    </select>\n                    <div class=\"modal-footer\">\n                      <input data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=\"submit\" class=\"btn update-button btn-primary\" name=\"submit\" value=\"Save Update\">\n                      <button class=\"btn btn-secondary\" data-dismiss=\"modal\">Close</button>\n                    </div>\n                    </fieldset>\n                  </form>\n                </div>\n              </div>\n            </div>\n          </div>\n\n\n\n";
